            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ${isExpanded ? "text-primary scale-125" : "text-slate-500"}
                `}
                >
                  {item.title}
                </div>
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-white/95 backdrop-blur-lg border-primary/20 shadow-xl shadow-primary/5 overflow-visible">
